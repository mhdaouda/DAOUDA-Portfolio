const translations = {
    fr: {
        ...
        'hero.roles.current.prefix': 'Je suis',
        'hero.roles.learning.prefix': 'Je me forme en :',
        'hero.roles.current': [
            'Ingénieur DevOps',
            'Ingénieur prod',
            'Web intégrateur',
        ...
        "projects.source.private": "Code source (privé)",
        ...
        "projects.flashcoder.desc": "Plateforme de formation pensée pour apprendre rapidement les nouvelles technologies, avec de la pratique, des révisions et des exercices. Le contenu couvre aussi des sujets comme la finance.",
        "projects.turbotech.desc": "Site vitrine de TurboTech Consulting : startup IT et digital au Bénin et à l’international (Afrique, Europe, Amérique). Présentation des services — développement web et mobile, infrastructure, cybersécurité et conseil — réalisations, équipe et contact.",
    ...
    en: {
        ...
        'hero.roles.current.prefix': 'I am a',
        'hero.roles.learning.prefix': 'I am training in:',
        'hero.roles.current': [
            'DevOps Engineer',
            'Production Engineer',
            'Web Integrator',
        ...
        "projects.source.private": "Source code (private)",
        ...
        "projects.flashcoder.desc": "Training platform designed to help users learn new technologies quickly through practice, revision, and exercises. The content also covers topics like finance.",
        "projects.turbotech.desc": "Marketing site for TurboTech Consulting: IT and digital partner based in Benin, serving Africa, Europe, and North America. Showcases web & mobile development, infrastructure, cybersecurity, and consulting — case studies, team, and contact.",
